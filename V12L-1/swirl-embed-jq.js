                ...
                productList = `
                    <div class="video-modal-product-block-list-ssv">
                        <div class="video-modal-product-tabs-ssv">
                            ...
                            <div class="vmp-tab-ssv" onclick="changeTabssv(this, 1);">Ask question</div>
                        </div>   
...
function fullScreenVideossv(btn) {
    ...
    // jQuery(btn).closest('.swiper-slide').addClass('rotateOn-ssv');
    // let vw = Math.floor((jQuery(btn).closest('.video-modal-video-container-ssv').find('video').width() - window.innerWidth) / 2);
    // jQuery(btn).closest('.video-modal-video-container-ssv').css('left', `-${vw}px`);
...
function changeTabssv(btn, n) {
    ...
    jQuery(btn).parents('.video-modal-product-block-ssv').find('.vmp-tab-ssv').toggleClass('open');
}
